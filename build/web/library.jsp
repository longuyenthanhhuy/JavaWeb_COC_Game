                                        ...
                                        <div class="col mb-5">
                                            ...
                                            <div class="card h-100">
                                                ...
                                                <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                                    <div class="text-center"><a class="btn btn-outline-dark mt-auto" ">Dowload</a></div>
                                                </div>
                                            </div>
                                        </div>
                                    </c:forEach>
                                    ...
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            ...
                                            <c:if test="${pages.page!=1}">
                                                <li class="page-item"><a class="page-link" href="library?page=1">Home</a></li>
                                                <li class="page-item"><a class="page-link" href="library?page=${pages.page-1}">Previous</a></li>

                                            </c:if>

                                            <c:forEach begin="${pages.pageStart}" end="${pages.pageEnd}" var="i"> 
                                                <li class="page-item ${i==pages.page?"active":""}"><a class="page-link" href="library?page=${i}">${i}</a></li>
                                                </c:forEach>

                                            <c:if test="${pages.page!=pages.totalPage}">
                                                <li class="page-item"><a class="page-link" href="library?page=${pages.page+1}">Next</a></li>
                                                <li class="page-item"><a class="page-link" href="library?page=${pages.totalPage}">End</a></li>
                                                </c:if>
